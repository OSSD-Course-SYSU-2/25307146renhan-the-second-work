...
const int32_t FLOAT_BTN_HEIGHT = 0x0100000e;
const int32_t FLOAT_BTN_TEXT_SIZE = 0x0100000f;
const int32_t FLOAT_COUNTDOWN_SIZE = 0x01000010;
const int32_t FLOAT_PAGE_TEXT_FONT_SIZE = 0x01000008;
const int32_t FLOAT_SPEAKER_SIZE = 0x01000011;
const int32_t FLOAT_TEXT_SIZE = 0x01000012;
const int32_t MEDIA_BACKGROUND = 0x01000001;
const int32_t MEDIA_CORN = 0x0100000d;
const int32_t MEDIA_FOREGROUND = 0x01000002;
const int32_t MEDIA_LAYERED_IMAGE = 0x01000003;
const int32_t MEDIA_SNOW = 0x0100000c;
const int32_t MEDIA_SNOW1 = 0x01000013;
const int32_t MEDIA_SNOW2 = 0x01000014;
const int32_t MEDIA_SNOW3 = 0x01000015;
